...
[common/consts.ts:70](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/common/consts.ts#L70)
...
[common/consts.ts:136](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/common/consts.ts#L136)
...
[common/consts.ts:236](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/common/consts.ts#L236)
...
[top-charts.ts:32](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/top-charts.ts#L32)
...
[top-charts.ts:22](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/top-charts.ts#L22)
...
[top-charts.ts:8](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/top-charts.ts#L8)
...
[top-charts.ts:67](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/top-charts.ts#L67)

## Functions

### fetchTopCharts

▸ **fetchTopCharts**(`request`, `options`): `Promise`<[`TopChartsResult`](README.md#topchartsresult)\>
...
`Promise`<[`TopChartsResult`](README.md#topchartsresult)\>

The top chart.

#### Defined in

[top-charts.ts:148](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/top-charts.ts#L148)
...
[top-charts.ts:161](https://github.com/baltpeter/parse-play/blob/4a05e6a/src/top-charts.ts#L161)
